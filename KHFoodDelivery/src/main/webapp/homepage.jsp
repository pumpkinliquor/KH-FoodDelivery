...
<div class="container">
	...
	<div class="menu2 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="" ng-click="select_home_category('1인분주문')">
	<div class="category-title">프랜차이즈</div><img class="i" src="${path}/resources/images/customer/main/핫도그.png"></a></div>
	
	<div class="menu3 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="" ng-click="select_home_category('1인분주문')">
	<div class="category-title">치킨</div><img class="i" src="${path}/resources/images/customer/main/치킨.png"></a></div>
	

	
	<div class="menu4 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href=""  ng-click="select_home_category('1인분주문')">
	<div class="category-title">피자</div><img class="i" src="${path}/resources/images/customer/main/피자.png"></a></div>
	
	<div class="menu5 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="" c ng-click="select_home_category('1인분주문')">
	<div class="category-title">중국집</div><img class="i" src="${path}/resources/images/customer/main/자장면.png"></a></div>
	
	<div class="menu6 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="" ng-click="select_home_category('1인분주문')">
	<div class="category-title">한식</div><img class="i" src="${path}/resources/images/customer/main/한식.png"></a></div>
	
	

	<div class="menu7 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="" ng-click="select_home_category('1인분주문')">
	<div class="category-title">족발/보쌈</div><img class="i" src="${path}/resources/images/customer/main/보쌈.png"></a></div>
	
	<div class="menu8 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href=""  ng-click="select_home_category('1인분주문')">
	<div class="category-title">분식</div><img class="i" src="${path}/resources/images/customer/main/분식.png"></a></div>
	
	<div class="menu9 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href=""  ng-click="select_home_category('1인분주문')">

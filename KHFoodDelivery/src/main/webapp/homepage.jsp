...
<div class="container">
	...
	<div class="menu1 col-xs-6 col-sm-4 col-md-3 col-lg-3 "><a href="${path}/customer/searchmenuView"  ng-click="select_home_category('1인분주문')">
	<div class="category-title">돈까스/일식</div> <img class="i" src="${path}/resources/images/customer/main/돈까스.png"></a></div>
	
	<div class="menu2 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="${path}/customer/searchmenuView" ng-click="select_home_category('1인분주문')">
	...
	<div class="menu4 col-xs-6 col-sm-4 col-md-3 col-lg-3"><a href="${path}/customer/searchmenuView"  ng-click="select_home_category('1인분주문')">
